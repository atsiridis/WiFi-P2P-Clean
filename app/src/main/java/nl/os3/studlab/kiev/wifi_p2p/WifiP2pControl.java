...
public class WifiP2pControl {
    ...
    private void receivedPacket(byte[] remoteAddress, byte[] packet) throws IOException{
        WiFiApplication.context.receivedPacket(remoteAddress, packet); // For Debugging
    }
